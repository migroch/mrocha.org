...
export default class Astro1 extends React.Component {
  ...
  renderWeekEvents(weekEvents){
	...
	<h3 className="bg-info text-center"> Wek 8: Gravity and Newtons Laws of Motion </h3>

	<p dangerouslySetInnerHTML={{__html: weekEvents[0]}}></p>
	<p dangerouslySetInnerHTML={{__html: weekEvents[1]}}></p>

	<p><a  href='FreeFallLab.pdf' target='_blank'>Lab 6: Measuring g </a></p>
  ...
  render(){
	...
	<div className="container syllabus">
	  ...
	  <div className="container-fluid row bpadding">
	    ...
	    {this.renderWeekEvents(syllabus.CourseSchedule[Object.keys(syllabus.CourseSchedule)[7]])} 
