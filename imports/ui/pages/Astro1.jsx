...
export default class Astro1 extends React.Component {
  ...
  renderWeekEvents(key, schedule){
	...
	<p> <a  href='https://ilearn.gavilan.edu/courses/7804/quizzes/18300' target='_blank'>Midterm 1</a></p>
  ...
  render(){
	...
	<div className="container syllabus">
	  ...
	  <div className="container-fluid row bpadding">
	    ...
	    {this.renderWeekEvents("Week 6: Formation of Solar System and Midterm 1", syllabus.CourseSchedule)} 
