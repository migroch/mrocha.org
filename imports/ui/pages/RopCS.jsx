  ...
  render() {
	...
	<div className="container-fluid nopadding">
	  ...
	  <div className= "container-fluid syllabus">
		...
		<h3 className="bg-info text-center">Week 8 - Operative Systems, The Unix Terminal and Data Driven Web Development </h3>

		<p><a href="http://slides.com/migroch/deck-2-6-10/fullscreen#/" target="_blank">Operative System and The Unix Terminal - Lecture Slides</a></p>
		...
		<p><a href="https://ide.c9.io/testst/html5-cloned2">Assigment 4: Create a two page website as shown in this C9 Workspace</a></p>
		
		<p><a href="http://slides.com/migroch/deck-1-3-8/fullscreen#/11">Assigment 3: Modify the html5 workspace</a></p>
