// GameDev.jsx
// Page component for the GameDev page
...
export default class GameDev extends React.Component {
  ...
  render() {
	...
	<div className="container-fluid nopadding">
	  <Helmet>
            <title>Game Software and Systems Development</title>
	  ...
	  <div className="container-fluid rop-header nopadding bpadding">
	    <div className="container text-center">
	      ...
	      <h2 className="teacherInfo"><small>Miguel Rocha - mrocha@scottsvalleyusd.org - <a href="https://mrocha.org/gamedev">mrocha.org/gamedev</a></small></h2>
	    </div>
	  </div>
	  ...
	  <div className= "container-fluid syllabus">
		...
		<h3 className="bg-info text-center">Week 10 - Importing Blender Models to Unity and Blender Animations </h3>
		...
		<iframe  src="https://calendar.google.com/calendar/embed?showTitle=0&amp;mode=AGENDA&amp;wkst=1&amp;bgcolor=%23FFFFFF&amp;src=a5cbqd6l3tc9i3ai524dervq28@group.calendar.google.com&amp;color=%230F4B38&amp;ctz=America%2FLos_Angeles" style={{borderWidth:0}} width="100%" height="350" frameBorder="0" scrolling="no" fontSize="500"></iframe>
	      </div>
	    ...
	    <div className="jumbotron ">
	      ...
	      <ul>
		<li><h3>Game concepts and technology</h3></li>
		<li><h3>Game engines</h3></li>
		<li><h3>Game design</h3></li>
		<li><h3>Game and software development</h3></li>
		<li><h3>Creating game assets (2d and 3d computer modeling)</h3></li>
		<li><h3>Packaging games for modern platforms</h3></li>
		<li><h3>Real-time networked games</h3></li>
		<li><h3>Dedicated servers for real-time networked games</h3></li>
		<li><h3>Game systems development (DevOps)</h3></li>
		<li> <h3>VR and XR</h3></li>
		<li><h3>Using AI for making realistic games</h3></li>
	      </ul>
	    </div>
